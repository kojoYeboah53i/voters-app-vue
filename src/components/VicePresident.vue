...
<div class="row mb-5">
   <div class="col-12 ">
       <div class="row justify-content-center">
           <div class="col-12">
               <h2 class="text-center">Vice Presidential Election</h2>
...
export default {
    ...
    methods: {
        submitVote(data) {
            ...
            const presidents = JSON.parse(localStorage.getItem('vice_presidents'))
            ...
            if(!localStorage.getItem('vice_president_voters')) {
                ...
                setTimeout(function(){
                      ...
                      setTimeout(function() {
                          localStorage.setItem('currentPage','general_secretary')
                          self.$router.replace('/vote/general_secretary')
                      },3000)

                  },1000)
            } else {
                const oldVoters = JSON.parse(localStorage.getItem('vice_president_voters'))
                const newArray = [user]
                ...
                localStorage.setItem('vice_president_voters', JSON.stringify(newVoters))
